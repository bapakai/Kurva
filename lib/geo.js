 ...
 * Used for cross-provider place dedupe (see lib/dedupe.js isDuplicatePlace) —
 * cheap in-memory check, no PostGIS round trip needed for this.
 */
...
module.exports = { parseGeographyPoint, toEwkt, haversineMeters };
